    ...
    return (
      ...
      <div className="row my-5">
        <div className="col">
          <div className="card d-flex justify-content-center">
            <h1 className="text-center my-4"><b>Nome: </b>{tarefa.titulo}</h1>
            <h4 className="text-center"><b>Prioridade: </b>{tarefa.prioridade}</h4>
            <h4 className="text-center"><b>Status: </b> {tarefa.statusTarefa}</h4>
            <h4 className="text-center"><b>Prazo: </b>{tarefa.prazo}</h4>
            <h4 className='text-center'>Descrição: <span>{tarefa.descricao}</span></h4>
      ...
      <Modal open={open} onClose={FechaModal} center showCloseIcon={false}>
        ...
        <div className='d-flex w-50 mx-auto justify-content-around'>
          ...
          <button className='btn btn-succes' onClick={handleDelete}>Sim!</button>
        </div>
      </Modal>
    </div>
  )
